...
export default function KallitheaPage() {
  ...
  return (
    <>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          <div className="max-w-3xl">
            <span className="inline-block bg-med-blue text-white px-4 py-2 text-sm font-semibold mb-6">
              South Athens
            </span>
      ...
      {/* Quick Stats */}
      <section className="py-16 bg-med-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="font-serif text-5xl font-bold text-amber-400 mb-2">4km</div>
              <div className="text-blue-100">From City Center</div>
            </div>
            <div>
              <div className="font-serif text-5xl font-bold text-amber-400 mb-2">15min</div>
              <div className="text-blue-100">Metro to Syntagma</div>
            </div>
            <div>
              <div className="font-serif text-5xl font-bold text-amber-400 mb-2">100k+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 shadow-lg">
              <div className="w-16 h-16 bg-med-blue/10 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-med-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {amenities.map((category, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="text-med-blue">{category.icon}</div>
