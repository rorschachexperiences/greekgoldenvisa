          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-6">
                <h3 className="font-semibold text-navy mb-2">Investment Requirement</h3>
                <p className="text-3xl font-serif font-bold text-navy">€250,000</p>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-navy flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white rounded-lg p-8 shadow-lg">
                <div className="text-navy mb-4">{benefit.icon}</div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 bg-navy text-white rounded-full flex items-center justify-center font-serif text-2xl font-bold">
                    {step.number}
                  </div>
                </div>
                <div>
      ...
      <section className="py-20 bg-navy text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="font-serif text-5xl font-bold text-gold mb-2">
                  {item.stat}
                </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-serif text-xl font-semibold text-white mb-3">Strategic Location</h3>
              <p className="text-white/60">
                At the crossroads of Europe, Asia, and Africa, Greece offers unparalleled connectivity for business and travel.
              </p>
            </div>
            <div>
              <h3 className="font-serif text-xl font-semibold text-white mb-3">Growing Economy</h3>
              <p className="text-white/60">
                Greece&apos;s economy is recovering strongly with tourism and property markets showing consistent growth.
              </p>
            </div>
            <div>
              <h3 className="font-serif text-xl font-semibold text-white mb-3">Quality of Life</h3>
              <p className="text-white/60">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={index} className="bg-cream rounded-lg p-6">
                ...
                <p className="text-charcoal">{item.a}</p>
              </div>
            ))}
          </div>
          <div className="text-center mt-8">
            <Link href="/faq" className="text-navy font-medium hover:underline">
              View All FAQs →
            </Link>
          </div>
        </div>
